...
public class ObservationTest {
    ...
    public void setUp() throws Exception {
        ...
        StoreableObservation obs1 = new StoreableObservation(1, 1, 1, 1, date, time, "no info", 1, "pekka", java.time.LocalDateTime.now());
        StoreableObservation obs2 = new StoreableObservation(2, 1, 1, 2, date, time, "no info", 0, "pekka", java.time.LocalDateTime.now());
    ...
    public void equalWhenSameId() throws Exception {
        ...
        StoreableObservation o = new StoreableObservation(1, 1, 1, 1, date, time, "no info", 1, "pekka", java.time.LocalDateTime.now());
